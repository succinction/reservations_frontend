...
function (_Component) {
  ...
  function Accordion(props) {
    ...
    _this.clickTarget = document.getElementById(_this.props.actionID);
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Accordion, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.props.isSubAccordionOpen) {
        ...
        var icn = "#".concat(this.props.ID, "_arrow");
        gsap__WEBPACK_IMPORTED_MODULE_8__["TweenLite"].set(icn, {
          rotationX: -180
        });
      }
...
//# sourceMappingURL=index.js.67e3cbfa3946878c99f6.hot-update.js.map